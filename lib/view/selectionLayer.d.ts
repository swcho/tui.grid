...
export declare const SelectionLayer: {
    new (props?: OwnProps | undefined, context?: any): {
        ...
        setState<K extends "styles">(state: Pick<StoreProps, K>, callback?: (() => void) | undefined): void;
        setState<K extends "styles">(fn: (prevState: StoreProps, props: OwnProps) => Pick<StoreProps, K>, callback?: (() => void) | undefined): void;
