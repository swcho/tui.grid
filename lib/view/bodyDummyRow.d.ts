...
export declare const BodyDummyRow: {
    new (props?: OwnProps | undefined, context?: any): {
        ...
        setState<K extends "rowHeight">(state: Pick<StoreProps, K>, callback?: (() => void) | undefined): void;
        setState<K extends "rowHeight">(fn: (prevState: StoreProps, props: OwnProps) => Pick<StoreProps, K>, callback?: (() => void) | undefined): void;
